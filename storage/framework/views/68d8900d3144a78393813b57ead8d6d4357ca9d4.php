...
<div class="login-box">
    <div class="login-logo">
        <a href="<?php echo e(asset('assets')); ?>/admin/index2.html"><b>Admin</b>LTE</a>
    </div>
    <!-- /.login-logo -->
    <div class="card">
        <div class="card-body login-card-body">
            ...
            <form action="<?php echo e(route('admin_logincheck')); ?>" method="post">
                <?php echo csrf_field(); ?>
...
<?php /**PATH /Users/demir/Desktop/LaravelProject/eticaret2/resources/views/admin/login.blade.php ENDPATH**/ ?>