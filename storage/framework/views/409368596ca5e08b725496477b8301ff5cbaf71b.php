...
<nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
        ...
        <li class="nav-item d-none d-sm-inline-block">
            <a href="<?php echo e(route('admin_home')); ?>" class="nav-link">Home</a>
        </li>
        <li class="nav-item d-none d-sm-inline-block">
    ...
    <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                <a href="<?php echo e(route('admin_home')); ?>" class="dropdown-item">
                    <!-- Message Start -->
                    <div class="media">
...
<!-- /.navbar -->
<?php /**PATH /Users/demir/Desktop/LaravelProject/eticaret2/resources/views/admin/_header.blade.php ENDPATH**/ ?>